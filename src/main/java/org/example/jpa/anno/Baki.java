...
///**
// * 用于扩展jpa执行sql的Baki注解，配合注解 {@linkplain  Query @Query} 一起工作
// * <blockquote>
// * e.g.
// * <pre>
...
// *     {@linkplain Baki @Baki}
// *     {@linkplain Query @Query}(value = {@code "&test.now"}, countQuery = {@code "select 10"}, nativeQuery = {@code true})
...
// *     <li>属性 {@linkplain Query#value() value} 为sql字符串或者sql名，e.g. {@code &my.query}</li>
// *     <li>属性 {@linkplain Query#countQuery() countQuery} 为分页查询的条数查询sql或sql名</li>
// * </ul>
// * 标注此注解的方法参数值遵循以下原则：
// * <ul>
